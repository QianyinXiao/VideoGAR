...
from method_core.config import BaseOptions
from method_core.model import VideoGARModel
from method_core.start_end_dataset import StartEndDataset, start_end_collate, StartEndEvalDataset, prepare_batch_inputs
from method_core.inference import eval_epoch, start_inference
from method_core.optimization import BertAdam
...
def start_training():
    ...
    model = VideoGARModel(model_config)
