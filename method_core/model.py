...
from method_core.model_components import (BertAttention, LinearLayer, BertSelfAttention,
                                         TrainablePositionalEncoding, CrossAttentionLayer)
from method_core.model_components import MILNCELoss
from method_core.contrastive import batch_video_query_loss
from method_core.bimamba import BiMambaEncoderLayer
from method_core.query_decoder import QueryDecoder
...
class VideoGARModel(nn.Module):
    def __init__(self, config):
        super(VideoGARModel, self).__init__()
        self.config = config
